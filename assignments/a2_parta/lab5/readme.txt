This program is meant to take the input from one file and output every
second character from the first file into the second file. 

You would call this program as follows: 

./alternate input.txt output.txt

which would output each second chacter (starting at character number 2) 
to the output file.
...
correct_alternate so you know what the final desired behaviour of the 
program is.
